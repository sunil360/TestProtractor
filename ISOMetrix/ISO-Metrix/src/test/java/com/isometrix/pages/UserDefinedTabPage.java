...
//"#control_7A7F4CBC-FEF4-48A9-B850-FC89A5E4F5C3>div>div>ul>ul>li
	...
	public void enterAllMandatoryFieldOnUserDefinedTab() throws Exception {
		  String userdefinedCBL1 = propertyReader.readApplicationData("userdefinedCBL1");
		  userDefined_DDL1("Test 2");
		  userDefined_CBL1(new String[] { userdefinedCBL1 });
	 ...
	 @FindBy(css = "#divMessage #txtHeader")
	 WebElement recordSaved;
	 public void verifyRecordSaved() {
	  verifyElementPresent(recordSaved);
